...
const REGISTRY = [
  ...
  // —— Chi siamo ——
  ...bi('chi.intro_title', '品牌页', '页首标题', T,
    'Un\'azienda italiana, un mestiere serio',
    'An Italian company, a serious trade'),
  ...bi('chi.intro_body', '品牌页', '页首介绍', TA,
    'Convation nasce per fare bene una cosa sola: portare climatizzazione e pompe di calore nelle case e nelle imprese, con la serietà di chi installa e assiste ciò che vende.',
    'Convation exists to do one thing well: bring air conditioning and heat pumps to homes and businesses, with the seriousness of a company that installs and services what it sells.'),
  ...bi('chi.story_body', '品牌页', '品牌故事（空行分段）', TA,
    'Siamo un\'azienda registrata in Italia con radici nella filiera HVAC europea: conosciamo i produttori, i componenti e i prezzi reali del mercato.\nPer questo possiamo scegliere i marchi giusti, formare gli installatori e garantire i ricambi. La climatizzazione è il nostro unico mestiere, non un reparto.',
    'We are a company registered in Italy with roots in the European HVAC supply chain: we know the manufacturers, the components and the real market prices.\nThat is why we can pick the right brands, train installers and guarantee spare parts. HVAC is our only trade, not a department.'),
  ...bi('chi.value1_title', '品牌页', '价值1 · 标题', T, 'Competenza', 'Expertise'),
  ...bi('chi.value1_body', '品牌页', '价值1 · 介绍', TA,
    'Tecnici certificati F-Gas e formazione continua sui prodotti che trattiamo.',
    'F-Gas certified technicians and continuous training on the products we carry.'),
  ...bi('chi.value2_title', '品牌页', '价值2 · 标题', T, 'Trasparenza', 'Transparency'),
  ...bi('chi.value2_body', '品牌页', '价值2 · 介绍', TA,
    'Preventivi chiari, tempi dichiarati e garanzie scritte. Nessuna sorpresa in fattura.',
    'Clear quotes, stated lead times and written warranties. No surprises on the invoice.'),
  ...bi('chi.value3_title', '品牌页', '价值3 · 标题', T, 'Responsabilità', 'Accountability'),
  ...bi('chi.value3_body', '品牌页', '价值3 · 介绍', TA,
    'Assistiamo tutto ciò che vendiamo, in garanzia e fuori garanzia.',
    'We service everything we sell, in and out of warranty.'),
  ...bi('chi.cred_body', '品牌页', '资质说明（文件后补）', TA,
    'Certificazione F-Gas, abilitazioni DM 37/08 e coperture assicurative: i documenti aziendali sono in caricamento e saranno pubblicati in questa pagina.',
    'F-Gas certification, DM 37/08 qualifications and insurance cover: company documents are being uploaded and will be published on this page.'),

  // —— Referenze ——
  ...bi('ref.intro_title', '案例页', '页首标题', T, 'Impianti veri, case vere', 'Real systems, real homes'),
  ...bi('ref.intro_body', '案例页', '页首介绍', TA,
    'Una selezione dei nostri lavori: per ogni intervento raccontiamo il contesto, la soluzione scelta e il perché. Le foto arrivano man mano che i cantieri si chiudono.',
    'A selection of our work: for each job we describe the context, the chosen solution and the reasoning. Photos arrive as each site is completed.'),
  ...bi('ref.case1_desc', '案例页', '案例1 · 方案', TA,
    'Pompa di calore aria-acqua monoblocco con accumulo sanitario: caldaia dismessa, impianto a pavimento esistente mantenuto.',
    'Monobloc air-to-water heat pump with hot-water tank: boiler retired, existing underfloor system kept.'),
  ...bi('ref.case2_desc', '案例页', '案例2 · 方案', TA,
    'Multi split 3×1 a parete con unità esterna a balcone: raffrescamento estivo e supporto invernale nelle mezze stagioni.',
    'Wall-mounted 3×1 multi split with balcony outdoor unit: summer cooling plus shoulder-season heating support.'),
  ...bi('ref.case3_desc', '案例页', '案例3 · 方案', TA,
    'Cassette a 4 vie su controsoffitto con comando centralizzato e manutenzione programmata semestrale.',
    'Four-way ceiling cassettes with centralised control and six-monthly scheduled maintenance.'),

  // —— Documentazione ——
  ...bi('doc.intro_title', '文档页', '页首标题', T,
    'Documenti tecnici, senza caccia al tesoro',
    'Technical documents, no treasure hunt'),
  ...bi('doc.intro_body', '文档页', '页首介绍', TA,
    'Schede tecniche, cataloghi e manuali dei prodotti che trattiamo, raccolti in un unico posto. La sezione si riempie insieme al catalogo.',
    'Data sheets, catalogues and manuals for the products we carry, gathered in one place. This section grows together with our catalogue.'),
